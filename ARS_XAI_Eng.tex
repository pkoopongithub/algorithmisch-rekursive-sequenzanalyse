...
solution, the paper develops \textbf{Algorithmic Recursive Sequence Analysis (ARSA)} , 
...
paper develops \textbf{Algorithmic Recursive Sequence Analysis (ARSA)} , a procedure 
...
ARSA understands itself as such a procedure—as a contribution to an \textbf{explainable 
...
AI and develops the analogy to qualitative research. Section 3 presents ARSA in its 
...
Methods & LIME, SHAP, Saliency Maps & ARSA, explicit category formation \\
...
ARSA operates on transcripts of natural interactions. The first step consists of a 
...
Unlike classical linguistic PCFGs \citep{Manning1999}, ARSA dispenses with explicit 
...
\section{Discussion: ARSA as a Contribution to Explainable Qualitative Research}

\subsection{ARSA and the XAI Criteria}

ARSA fulfills the three NIST criteria for good explanations in a form adapted to 
...
\subsection{Ad-hoc vs. Post-hoc: ARSA as Explanation by Design}

In XAI terminology, ARSA is to be classified as an \textbf{ad-hoc procedure} 
...
This fundamentally distinguishes ARSA from post-hoc procedures that attempt to 
subsequently explain the decisions of neural networks. While these procedures can 
only provide approximate insights into a principally opaque architecture, ARSA is 
...
particular decision; in ARSA, we explain how researchers arrived at a particular 
interpretation.
...
ARSA, on the other hand, there are no \enquote{actual} processes that exist 
...
developers, or regulatory authorities. ARSA explanations are directed at the 
...
ARSA provides a concrete answer to these questions. It formalizes interpretation 
...
Further research could develop ARSA in several directions: through the integration 
